document.addEventListener('DOMContentLoaded', function() {
    ...
    // Carrega tipos de massagem da API
        ...
        fetch('/api/servicos')
            ...
            .then(servicos => {
                ...
                servicos.forEach(servico => {
                    const opt = document.createElement('option');
                    opt.value = servico.id; // ID numérico do banco
            ...
            .catch(() => {
                ...
                selectTipo.innerHTML = '<option value="">Erro ao carregar serviços</option>';
            });
    }
    ...
    form.addEventListener('submit', function(e) {
        ...
        const payload = { 
            data, 
            hora, 
            servico_id: tipoMassagem, // Alterado de tipo_massagem para servico_id
